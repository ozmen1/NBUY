    ...
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(u => u.Email)
                .IsRequired()
                .HasMaxLength(50);
            builder.HasIndex(u => u.Email).IsUnique(); //benzersiz değer özelliği, aynı e-mail adresi 2. kez verilemez.
            ...
            builder.HasData(
                new User
                {
                    ...
                    PasswordHash= Encoding.ASCII.GetBytes("200820e3227815ed1756a6b531e7e0d2") //qwe123 şifremizin hashlen iş halidir.
                },
                new User
                {
                    Id = 2,
                    ...
                    PasswordHash = Encoding.ASCII.GetBytes("46f94c8de14fb36680850768ff1b7f2a") //123qwe şifremizin hashlen iş halidir.
                });
        }
    }
}
