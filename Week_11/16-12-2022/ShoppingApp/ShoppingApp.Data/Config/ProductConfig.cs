...
namespace ShoppingApp.Data.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(p => p.Id).ValueGeneratedOnAdd(); //Id'ler arttırılabilir oldu
            ...
            builder.Property(p => p.DateAdded)
                .HasDefaultValueSql("date('now')"); //sqlite yazım biçimi .HasDefaultValueSql("getdate()"); (sql server ile çalışırken kullanma şeklimiz.)
