...
function removeTask(id){
    ...
    //ALTERNATİF MODERN JAVASCRIPT YÖNTEMLERİ
    //ES6 için çözüm (findIndex methodu da kullanılabilir)
    // deletedId=gorevListesi.findIndex(function(gorev){
    //     return gorev.id == id;
    // });

    //ES6 için daha kısa çözüm
    // deletedId = gorevListesi.findIndex(gorev => gorev.id == id);

    // console.log(id, deletedId);
    //artık görevListesi dizisinden kaçıncı sıradaki elemanın silineceğini biliyoruz. deletedId'nci sıradaki elemanı sileceğiz.
