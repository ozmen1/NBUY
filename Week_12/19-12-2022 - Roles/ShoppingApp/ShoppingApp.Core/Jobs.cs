...
namespace ShoppingApp.Core
{
    public static class Jobs //static yaparak new yapılmasını engelledik
    {
        ...
        public static string CreateMessage(string title, string message, string alertType) //istediğimiz zaman istediğimiz mesajın görünmesi için
        {
            ...
            return JsonConvert.SerializeObject(msg); //mesajı json'a dönüştürdük.

            //CreateMessage("Dikkat", "Kayıt silinecektir", "danger") ---> json formatına dönecek!!!
            //json ile taşımak daha az sorun çıkardığı için json'a çevirdik.
        }
    }
}
