    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Edit(ProductUpdateDto productUpdateDto, int[] selectedCategoryIds)
        {
            if (ModelState.IsValid)
            {
                ...
                //image url'in null olma durumunu kontrol ettik
                var url= Jobs.InitUrl(productUpdateDto.Name);
                var imageUrl = productUpdateDto.ImageUrl != null ? Jobs.UploadImage(productUpdateDto.ImageFile) : product.ImageUrl;
                //image url'in null olma durumunu kontrol ettik
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _productService.Delete(product); //Delete jenerik bir metottu en başta tanımladık.
            return RedirectToAction("Index");
        }
    }
}
