    ...
    public class KitabeviContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitap>()
                .HasData(
                    new Kitap() { AnaSayfa=true, Id = 1, Ad = "İnsanlar", BasimYili = 2021, SayfaSayisi = 330, KategoriId = 2, YazarId = 1, Ozet="Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum iure quas dolores, alias maxime, asperiores fugiat rerum inventore neque reiciendis voluptatem delectus optio recusandae fugit laborum aut doloremque? Dicta, debitis." },
