    ...
    public class SqlProductDAL : IProductDAL
    {
        ...
        public List<Product> GetProductsByCategory(string categoryName)
        {
            ...
            using (var connection = GetSqlConnection())
            {
                ...
                {
                    connection.Open();
                    string queryString = $"SELECT P.ProductID, P.ProductName, P.UnitPrice, P.UnitsInStock FROM Products P INNER JOIN Categories C ON P.CategoryID = C.CategoryID WHERE CategoryName = '{categoryName}'";
                    SqlCommand sqlCommand = new SqlCommand(queryString, connection);
                    SqlDataReader sqlDataReader = sqlCommand.ExecuteReader();
                    while (sqlDataReader.Read())
                    {
